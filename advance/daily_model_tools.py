...
import numpy as np
import xarray as xr
from oggm import entity_task, cfg, utils
...
def run_with_hydro_daily(gdir,
    ...
    This task is not part of the official OGGM workflow. It was adapted for this
    tutorial from ideas developed in the OGGM mass-balance sandbox and related
    work by Schuster et al. (2023) and Hanus et al. (2024).

    The function is intended as a prototype/teaching tool for daily hydro
    diagnostics. Similar functionality may become available in future OGGM
    versions, but the official implementation may differ, especially in how
    runoff components are computed and stored.
